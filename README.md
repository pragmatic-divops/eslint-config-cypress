...
Shareable config for ESLint for projects that use Cypress, which extends [@form8ion/eslint-config-cypress](https://github.com/form8ion/eslint-config-cypress)
